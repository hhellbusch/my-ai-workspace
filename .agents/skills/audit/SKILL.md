---
name: audit
description: Comprehensive content audit — link integrity, registry alignment, cross-references,
  and freshness
...
<context>
- Repo structure conventions: `.cursor/rules/repo-structure.mdc`
...
- Count actual files in `.agents/skills/`, `.cursor/skills/`, `.cursor/agents/`
...
- **Skills**: skills in `.agents/skills/` (auto-discovered; no registry needed)
...
- If any `.agents/skills/*/SKILL.md` references files via @ syntax that don't exist
...
- **Meta-system**: `.agents/skills/**/*.md`, `.cursor/skills/**/*.md`, `.cursor/rules/*.md`
