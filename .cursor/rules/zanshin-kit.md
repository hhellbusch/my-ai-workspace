...
**At session start, read [`zanshin-kit/WORKING-STYLE.md`](../../zanshin-kit/WORKING-STYLE.md).** It is the canonical, portable definition of the working practices — spar, shoshin, progressive bookkeeping, stack tracking, verification, and review discipline. The rules in this workspace (`shoshin.md`, `session-awareness.md`, `review-tracking.md`, etc.) extend it with workspace-specific depth; they don't replace it.
