...
Plans:
- [ ] 01-01: User populates personal-notes.md and curated-reading.md (checkpoint: human input)
- [ ] 01-02: Build research manifest merging curated sources with web-discoverable URLs
...
### Phase 2: Research
**Goal**: Source library populated, batched analysis complete, themes synthesized
**Depends on**: Phase 1 (manifest needs curated sources)
**Plans**: 2 plans
...
Plans:
- [ ] 04-01: Research meta-prompt for Essay 2
