...
- **Deployment progression:**
  ...
  - **Stage 3 — Platform model (SNO):** Everything on OpenShift. OpenShift AI for inference, GitOps managing agent infrastructure. Enterprise architecture in miniature.
