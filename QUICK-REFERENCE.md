...
- **PR Workflow Guide**: [PR-WORKFLOW-GUIDE.md](PR-WORKFLOW-GUIDE.md) ⭐ **Essential reading**
- **Two-Repo Tagging**: [TWO-REPO-TAG-WORKFLOW.md](TWO-REPO-TAG-WORKFLOW.md) ⭐ **Understand tagging**
- Full documentation: [APP-OF-APPS-PATTERN.md](APP-OF-APPS-PATTERN.md)
