...
**Browse the site** (full-text search, unified nav): [hhellbusch.github.io/my-ai-workspace](https://hhellbusch.github.io/my-ai-workspace/)
...
**Read on GitHub or the site** — essays and case studies are written for external readers. Any file link works standalone on GitHub; the [docs site](https://hhellbusch.github.io/my-ai-workspace/) adds search and sidebar navigation across `devops/` and `docs/`.
