...
applications:
  - name: example-app              # Application name
    ...
    path: argo-examples/apps/example-app  # Path in repo
...
```bash
cd argo-examples/charts/argocd-apps
...
# 2. Edit values file
vim argo-examples/charts/argocd-apps/values-production.yaml
# Change targetRevision: v1.2.3 -> targetRevision: v1.3.0

# 3. Commit and push branch
git add argo-examples/charts/argocd-apps/values-production.yaml
