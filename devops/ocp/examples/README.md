...
Cross-DC Kafka replication: start at **[architecture overview](messaging/kafka/cross-dc-architecture-overview.md)** — full track index in [messaging/README.md](messaging/README.md).

- **[Kafka on bare-metal with Portworx](messaging/kafka/bare-metal-portworx/README.md)** — Rack-aware CFK/Strimzi, OCP 4.20+ (single-cluster)
