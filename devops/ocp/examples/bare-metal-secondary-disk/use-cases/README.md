...
|---|----------|------------------|-------|--------|
| 1 | Node logs + journal | `/var/log`, journal growth | [**`/var/log` (full)**](../../bare-metal-var-log-disk/README.md) | Complete |
...
|-------|------------------|
| Ignition vs script `MachineConfig` | [var-log guide](../../bare-metal-var-log-disk/README.md) |
