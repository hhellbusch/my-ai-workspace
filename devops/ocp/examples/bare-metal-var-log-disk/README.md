...
**Parent guide:** [Secondary disk offload overview](../bare-metal-secondary-disk/README.md) · [Use-case index](../bare-metal-secondary-disk/use-cases/README.md)
...
**Related:** [MachineConfig pools](../../notes/machine-config-pools.md) · [SNO lab disk mount](../sno-kvm-lab/hpp-vdb-mount.yaml) · [Ignition operator notes](https://coreos.github.io/ignition/operator-notes/)
...
Validate `by-path` in CI on sample nodes before merge — see [kafka bare-metal inventory pattern](../kafka-bare-metal-portworx/README.md#acm-provisioning-and-inventory).
