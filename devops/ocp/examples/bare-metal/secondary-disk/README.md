...
| 2 | **Node logs + journal** | 64–512 GiB | `MachineConfig` mount `/var/log` | [**`/var/log` (full)**](../var-log-disk/README.md) |
...
- [approach-a-ignition.yaml](../var-log-disk/approach-a-ignition.yaml)
- [approach-b-script-systemd.yaml](../var-log-disk/approach-b-script-systemd.yaml)
...
| [`/var/log` + journal](../var-log-disk/README.md) | **Complete** (A vs B MC) | A / B |
...
- [SNO local storage](../../labs/sno-kvm-lab/local-storage.md) — Pattern C on a lab VM
- [Kafka + Portworx bare metal](../../messaging/kafka/bare-metal-portworx/README.md)
