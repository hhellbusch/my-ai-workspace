...
Lab reference: [SNO local storage](../../../labs/sno-kvm-lab/local-storage.md).
...
**Note:** use `-part2` suffix on the NVMe `by-path` (e.g. `…-nvme-1-part2`) when p1 is the log partition from [var-log](../../var-log-disk/README.md), or prefer `/dev/disk/by-partlabel/<label>` if p2 has a GPT name in Git.
...
SNO target: [lvms.yaml](../../../labs/sno-kvm-lab/lvms.yaml), [dynamic-storage.md](../../../labs/sno-kvm-lab/dynamic-storage.md).
...
PVC smoke test: [storage-smoke-test.yaml](../../../labs/sno-kvm-lab/storage-smoke-test.yaml).
...
- [var-log](../../var-log-disk/README.md) — p1 log slice
- [Kafka bare metal + Portworx](../../../messaging/kafka/bare-metal-portworx/README.md)
