...
| Rack-aware replication | Align [node labels](../../../messaging/kafka/bare-metal-portworx/README.md) with storage failure domains |
...
- [Kafka + Portworx example](../../../messaging/kafka/bare-metal-portworx/README.md)
