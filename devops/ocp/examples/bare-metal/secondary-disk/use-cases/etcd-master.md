...
Same [var-log](../../var-log-disk/README.md) patterns apply with `machineconfiguration.openshift.io/role: master`.
...
- [Overview](../README.md)
- [Bare metal install examples](../../../networking/ovn-kubernetes-install-config/EXAMPLES.md) — `rootDeviceHints`
