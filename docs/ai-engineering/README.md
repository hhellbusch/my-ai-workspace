...
2. **[AI-Assisted Development Workflows](ai-assisted-development-workflows.md)** — Practical, tool-agnostic patterns for using AI coding assistants effectively in engineering work. Examples drawn from infrastructure (Ansible, ArgoCD, Helm, Kubernetes), but the underlying patterns — context sharing, verification discipline, multi-session project management, meta-development systems — apply to any domain.
