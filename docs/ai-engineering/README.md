...
- **[Software Systems Maturity — a trailhead](software-systems-maturity.md)** — Multi-axis maturity model (2016 deck resurrected for 2026): assess per-axis level, prioritize the next step up. Nine core axes plus proposed expansions for platform, GitOps, and AI agents. Domain-specific ladders (e.g. cluster-link GitOps) nest under broader axes.
