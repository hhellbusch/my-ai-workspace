...
| [Case Studies as Discovery](../case-studies/case-studies-as-discovery.md) | Writing a case study surfaced three gaps with no existing fix | [Shoshin principles](../../AGENTS.md) (Session Awareness / Shoshin sections), [CHANGELOG.md](../../.planning/zen-karate/CHANGELOG.md), `/start` step 2.5, others | Filled the gaps the case study named — the same session |
| [When AI Fabricates Evidence](../case-studies/fabricated-references.md) | No external URL verification anywhere in the workflow | URL verification step in [`/review`](../../.agents/skills/review/SKILL.md) and [cross-linking rule](../../AGENTS.md) | Applied to the essay that contained the fabricated URL |
