...
With AI, building the tool is fast. A [`/spar` command](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md) went from idea to working implementation in one exchange. A [`fetch-transcript.py`](../../.agents/skills/research-and-analyze/scripts/fetch-transcript.py) script was written, tested, and integrated in three exchanges. A [zero-base evaluation step](../../.agents/skills/backlog/SKILL.md) was designed and added to an existing command in minutes.
...
The [`/spar` command](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md) was applied to the essay it was built to challenge *in the same session*. It produced [7 counterarguments](../../research/zen-karate-philosophy/sparring-notes.md#1-the-core-claim-is-unverified), several of which identified genuine structural weaknesses. The [research skill](../../.agents/skills/research-and-analyze/SKILL.md) was validated against the same article whose manual verification had failed. The [zero-base evaluation](../../.agents/skills/backlog/SKILL.md) was used to re-prioritize the backlog that had exposed the anchoring problem.
...
|---|---|---|---|
| [Building a Research Skill](../case-studies/building-a-research-skill.md) | Manual verification failed — URLs blocked, context overflowed, nothing persisted | [Research automation skill](../../.agents/skills/research-and-analyze/SKILL.md) | Validated against the same article whose manual verification had failed |
| [Adversarial Review](../case-studies/adversarial-review-meta-development.md) | No pushback anywhere in the essay pipeline | [`/spar` command](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md), [spar pipeline stage](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md) | 7 counterarguments against the essay that prompted the build |
...
| [Case Studies as Discovery](../case-studies/case-studies-as-discovery.md) | Writing a case study surfaced three gaps with no existing fix | [Shoshin rule](../../.cursor/rules/shoshin.mdc), [CHANGELOG.md](../../.planning/zen-karate/CHANGELOG.md), `/start` step 2.5, others | Filled the gaps the case study named — the same session |
| [When AI Fabricates Evidence](../case-studies/fabricated-references.md) | No external URL verification anywhere in the workflow | URL verification step in [`/review`](../../.agents/skills/review/SKILL.md) and [cross-linking rule](../../.cursor/rules/cross-linking.mdc) | Applied to the essay that contained the fabricated URL |
...
| [Zanshin — Patterns, Behaviors, and Why](session-framework.md) | The framework the loop built — behavioral map of what each practice defends against and how they fit together |
| [Zanshin — Portable Session Context](framework-bootstrap.md) | Single-file entry point for loading Zanshin into any AI tool |
