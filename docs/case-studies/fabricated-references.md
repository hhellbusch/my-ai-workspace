...
The project already had a [cross-linking rule](../../AGENTS.md) (an always-applied AI instruction file that maintains internal references between documents). External links had no equivalent protection. Two changes:
...
| [cross-linking rule](../../AGENTS.md) (Cross-Linking section) | The rule updated with external URL verification |
