...
The [`/spar` command](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md) generates steel-manned counterarguments against any essay or idea, each typed and rated for strength. Spar #9 from the Full Cup review:
...
| [/spar command](../../submodules/zanshin-pi-extension/skills/spar/SKILL.md) | The adversarial review tool that started the pipeline |
