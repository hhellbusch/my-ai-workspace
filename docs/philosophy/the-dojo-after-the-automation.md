...
> Most companies are opaque: unclear vision, missing or decayed SOPs, inconsistent output, knowledge trapped in individual heads, soul-crushing meetings, empire-building politics.
...
## What the Dojo Produces

The dojo — whether a literal martial arts training hall or the metaphorical equivalent in a team, an organization, a practice — produces something that can't be reduced to a skill file or an SOP.
...
There is a version of this story that isn't defensive — that doesn't just argue "we should invest in people even though automation is coming." The constructive version says: the best AI systems co-evolve with their operators.

Consider two loops:

**The system loop (Miessler's focus):** The person uses the system. The system captures signals — what worked, what failed, what the person corrected. The system improves. The person gets better output. Repeat.
...
## What Are We Building People For?

The question that started this essay deserves a direct answer.

We are building people for the thing that comes after execution automates. Not a specific role — the roles haven't been invented yet. Not a specific skill set — the required skills will change faster than any curriculum can track. We are building the *capacity* to direct, to judge, to create, to adapt.
...
This essay is a philosophical position paper. It names the stakes and articulates a stance. What it does not yet have:
...
| [The Shift — Engineering Skills in the Age of AI](../ai-engineering/the-shift.md) | The new skills (decomposition, verification, communication) reframed as survival, not career advice |
| [Thread 20: The Dojo After the Automation](../../.planning/zen-karate/threads.md) | Thesis development, voice inputs #5-16, spar #9 response |
| *Accelerate* (Forsgren, Humble, Kim, 2018) | Evidence gap — culture investment → business outcomes (cataloged, not yet deeply engaged) |
