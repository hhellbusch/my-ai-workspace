...
## [2026-05-30] ingest | Mo Bitar — AI coding will be a minimum wage job
- **Entry:** [mo-bitar-ai-coding-minimum-wage.md](mo-bitar-ai-coding-minimum-wage.md)
- **Wing:** ai-engineering
- **Source:** YouTube / research/ingest-queue/sources/ai-coding-will-be-a-minimum-wage-job.md
- **Note:** Prompt ceiling (shrinks with model releases). Doctor vs MRI tech analogy. FOMO critique of CEO advice. 5th Mo Bitar entry.
...
- **Wing:** ai-engineering
- **Source:** YouTube / research/ingest-queue/sources/handoff-is-my-new-favourite-skill.md
- **Note:** /handoff skill = external /whats-next equivalent. Dumb zone at ~120k independently corroborates Dex Horthy. Compact vs handoff. DIY sub-agent (fork + return). Cross-agent portability.
...
- **Wing:** ai-engineering
- **Source:** YouTube / research/ingest-queue/sources/everything-we-got-wrong-about-research-plan-implement---dexter-horthy.md
- **Note:** Primary source for the "dumb zone" concept. Instruction budget (150-200 max). RPI post-mortem. Design concept artifact. "Do not outsource the thinking." Read the code.
...
- **Wing:** ai-engineering
- **Source:** YouTube / research/ingest-queue/sources/a-love-letter-to-pi-lucas-meijer.md
- **Note:** Unity co-creator. Marble Madness model for agent-friendly repos; evaluation packs; Pi `/tree` for context branching; Barbapapa self-morphing software; dumb zone at 50%. Build Monumental channel.

## [2026-05-30] ingest | Mario Zechner — Building pi in a World of Slop (AI Engineer)
- **Entry:** [mario-zechner-pi-world-of-slop.md](mario-zechner-pi-world-of-slop.md)
- **Wing:** ai-engineering
- **Source:** YouTube / research/ingest-queue/sources/building-pi-in-a-world-of-slop-mario-zechner.md
- **Note:** Creator of Pi (used in this workspace). Context ownership; minimal harness thesis; agents compound errors; clankers destroying OSS; "slow the f*** down." AI Engineer London 2026.
