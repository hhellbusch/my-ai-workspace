...
| `software-systems-maturity/` | Resurrect 2016–2017 maturity deck — trailhead + axis deep dives | In progress | [trailhead](../docs/ai-engineering/software-systems-maturity.md) · [deep dives](../docs/ai-engineering/maturity/README.md) · [artifact map](software-systems-maturity/findings/artifact-map.md) |
