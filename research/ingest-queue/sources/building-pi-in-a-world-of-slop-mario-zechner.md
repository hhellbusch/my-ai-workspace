...
**[10:41]** Um and if you want to know more about Pi and Personal Agent Gateway, go to this talk, please.

**[10:44]** Yeah, and then eventually Peter happened. He put Pi inside of Personal Agent Gateway as it's a gent core, which meant my open source project became the target of a lot of Personal Agent Gateway instances unbeknownst to their users.

**[10:56]** So, this is act two, OSS in the age of clankers. Clankers are destroying OSS.

**[10:59]** Here's Till Draw. They closed down the issue and pull request tracker. Here's Personal Agent Gateway's uh trackers. Here's mine. Half of that is Personal Agent Gateway instances who post garbage.
...
**[12:24]** Um so, here's how we should not work with agents and why, at least in my opinion. I wrote this on my blog a while ago, but the basic gist is we're having army of agents in your using beats on and you don't know that it's basically uninstallable malware, and Entropic built a C compiler. It kind of works, but actually doesn't, and we're hoping the next generation of molds will fix it. And here is Kerbal building a browser, and that's also super broken. Uh but the next generation will fix it. And SaaS is dead software is often 6 months, and my grandma just built herself a Spotify with her personal agent gateway.
