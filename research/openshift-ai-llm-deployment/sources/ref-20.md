...
**URL:** https://github.com/rh-aiservices-bu/llm-on-openshift/blob/main/serving-runtimes/vllm_runtime/README.md
...
You can also find a notebook example using Langchain to query vLLM in this repo [here](/rh-aiservices-bu/llm-on-openshift/blob/main/examples/notebooks/langchain/Langchain-vLLM-Prompt-memory.ipynb).
